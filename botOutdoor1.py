...
pid = os.getpid()
with open("pid_thread1.txt", "w") as file:
    file.write(str(pid)) 

#alamat grup Telegram
#url_maingroup = 'https://api.telegram.org/bot5955267891:AAHCHgC3K2x4xMMSbDtN6FVrXojkD0EqyDE/sendMessage?chat_id=-1001851139717&te#xt='
