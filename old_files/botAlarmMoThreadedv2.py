...
#url_maingroup = 'https://api.telegram.org/bot5370607491:AAHMaWTzgA5idGtgnXVJ5tg14jdBM6t9CS4/sendMessage?chat_id=-587649076&text='
...
def func():
    ...
    for olt in data:
        pool.apply_async(thread_function, (olt,))
